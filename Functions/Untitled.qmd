...
bias_hs <- bias_estimates(parameters, estimates, m, 10, "shrink_coefs_hs")
bias_ridge <- bias_estimates(parameters, estimates, m, 10, "shrink_coefs_ridge")
bias_mle <- bias_estimates(parameters, estimates, m, 10, "mle_coefs")
```
