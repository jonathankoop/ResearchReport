...
t1 <- Sys.time()
estimates <- estimate_edgelists(edgelists[31:50], parameters, covar, num_cores = ncores, m = m)
t2 <- Sys.time()
(diff.time <- t2 - t1)

save(estimates, file = "../GeneratedData/estimates_3150.RData")
```
